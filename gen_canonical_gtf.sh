perl gen_canonical_gtf.pl -s gencode.v38lift37.annotation.sorted.gtf -c data/Ensembl_canonoical.txt -o gencode.v38lift37.annotation.sorted.genename_changed.gtf -g gencode.v38lift37.annotation.sorted.genename_changed.canonical.gtf
